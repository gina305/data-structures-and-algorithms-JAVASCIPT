...
const toLastNames = people => {
  // Solution code here...
  let concatenated = people.map(function (personObj) {
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  const result = arr.reduce((returned, n) => returned + 1, 0);
  return result
};
...
const returnNames = (arr) => {
  // Solution code here...
  let elementCount = arr.reduce((elements, item) => {
...
const reversedString = (str) => {
  ...
  //reduce through string array and reverse stort them
