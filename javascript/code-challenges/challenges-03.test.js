...
const containsAnd = (arr) => {
  ...
  //filter for words
  let words = arr.filter(word => word.includes('and'))
...
const notInFirstArray = (forbiddenValues, arr) => {
  ...
  let forbidden = arr.filter(element => forbiddenValues.includes(element) === false);

  //return the array of forbidden values
  return forbidden
